...
func UserID(v puuid.ID) predicate.ObjectUser {
	return predicate.ObjectUser(sql.FieldEQ(FieldUserID, v))
}
...
func ObjectID(v puuid.ID) predicate.ObjectUser {
	return predicate.ObjectUser(sql.FieldEQ(FieldObjectID, v))
}
...
func IsVisited(v bool) predicate.ObjectUser {
	return predicate.ObjectUser(sql.FieldEQ(FieldIsVisited, v))
}
...
func LastVisit(v time.Time) predicate.ObjectUser {
	return predicate.ObjectUser(sql.FieldEQ(FieldLastVisit, v))
}
...
func UserIDNEQ(v puuid.ID) predicate.ObjectUser {
	return predicate.ObjectUser(sql.FieldNEQ(FieldUserID, v))
}

// UserIDIn applies the In predicate on the "user_id" field.
func UserIDIn(vs ...puuid.ID) predicate.ObjectUser {
	return predicate.ObjectUser(sql.FieldIn(FieldUserID, vs...))
}

// UserIDNotIn applies the NotIn predicate on the "user_id" field.
func UserIDNotIn(vs ...puuid.ID) predicate.ObjectUser {
	return predicate.ObjectUser(sql.FieldNotIn(FieldUserID, vs...))
}

// UserIDGT applies the GT predicate on the "user_id" field.
func UserIDGT(v puuid.ID) predicate.ObjectUser {
	return predicate.ObjectUser(sql.FieldGT(FieldUserID, v))
}

// UserIDGTE applies the GTE predicate on the "user_id" field.
func UserIDGTE(v puuid.ID) predicate.ObjectUser {
	return predicate.ObjectUser(sql.FieldGTE(FieldUserID, v))
}

// UserIDLT applies the LT predicate on the "user_id" field.
func UserIDLT(v puuid.ID) predicate.ObjectUser {
	return predicate.ObjectUser(sql.FieldLT(FieldUserID, v))
}

// UserIDLTE applies the LTE predicate on the "user_id" field.
func UserIDLTE(v puuid.ID) predicate.ObjectUser {
	return predicate.ObjectUser(sql.FieldLTE(FieldUserID, v))
}

// UserIDContains applies the Contains predicate on the "user_id" field.
func UserIDContains(v puuid.ID) predicate.ObjectUser {
	vc := string(v)
	return predicate.ObjectUser(sql.FieldContains(FieldUserID, vc))
}

// UserIDHasPrefix applies the HasPrefix predicate on the "user_id" field.
func UserIDHasPrefix(v puuid.ID) predicate.ObjectUser {
	vc := string(v)
	return predicate.ObjectUser(sql.FieldHasPrefix(FieldUserID, vc))
}

// UserIDHasSuffix applies the HasSuffix predicate on the "user_id" field.
func UserIDHasSuffix(v puuid.ID) predicate.ObjectUser {
	vc := string(v)
	return predicate.ObjectUser(sql.FieldHasSuffix(FieldUserID, vc))
}

// UserIDEqualFold applies the EqualFold predicate on the "user_id" field.
func UserIDEqualFold(v puuid.ID) predicate.ObjectUser {
	vc := string(v)
	return predicate.ObjectUser(sql.FieldEqualFold(FieldUserID, vc))
}

// UserIDContainsFold applies the ContainsFold predicate on the "user_id" field.
func UserIDContainsFold(v puuid.ID) predicate.ObjectUser {
	vc := string(v)
	return predicate.ObjectUser(sql.FieldContainsFold(FieldUserID, vc))
}
...
func ObjectIDContains(v puuid.ID) predicate.ObjectUser {
	vc := string(v)
	return predicate.ObjectUser(sql.FieldContains(FieldObjectID, vc))
}
...
func ObjectIDHasPrefix(v puuid.ID) predicate.ObjectUser {
	vc := string(v)
	return predicate.ObjectUser(sql.FieldHasPrefix(FieldObjectID, vc))
}
...
func ObjectIDHasSuffix(v puuid.ID) predicate.ObjectUser {
	vc := string(v)
	return predicate.ObjectUser(sql.FieldHasSuffix(FieldObjectID, vc))
}
...
func ObjectIDEqualFold(v puuid.ID) predicate.ObjectUser {
	vc := string(v)
	return predicate.ObjectUser(sql.FieldEqualFold(FieldObjectID, vc))
}
...
func ObjectIDContainsFold(v puuid.ID) predicate.ObjectUser {
	vc := string(v)
	return predicate.ObjectUser(sql.FieldContainsFold(FieldObjectID, vc))
}
...
func IsVisitedNEQ(v bool) predicate.ObjectUser {
	return predicate.ObjectUser(sql.FieldNEQ(FieldIsVisited, v))
}
