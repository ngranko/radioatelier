...
var (
	...
	ObjectsColumns = []*schema.Column{
		...
		{Name: "lat", Type: field.TypeFloat64, SchemaType: map[string]string{"mysql": "decimal(9,6)"}},
		{Name: "lng", Type: field.TypeFloat64, SchemaType: map[string]string{"mysql": "decimal(9,6)"}},
