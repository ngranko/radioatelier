...
func (ec *executionContext) unmarshalInputCreateObjectInput(ctx context.Context, obj interface{}) (ent.CreateObjectInput, error) {
	...
	fieldsInOrder := [...]string{"name", "description", "lat", "lng", "installedPeriod", "isRemoved", "removedPeriod", "source", "type", "tags", "createdAt", "updatedAt", "deletedAt", "lastSync", "notionID", "createdByID", "updatedByID", "deletedByID", "collectionIDs", "userInfoIDs", "cityID"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
