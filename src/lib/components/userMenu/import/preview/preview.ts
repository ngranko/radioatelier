export const fieldList = [
    ...
    },
    {
        ...
        required: false,
        validation:
            'Список тегов, разделенных точкой с запятой или запятой. Например: tag1; tag2; tag3 или tag1, tag2, tag3. Максимальная длина каждого тега - 128 символов. Слишком длинные теги будут обрезаны.',
    },
    {
        name: 'privateTags',
