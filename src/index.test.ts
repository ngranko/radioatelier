...
describe('readExifOrientation', () => {
    it('finds orientation in a later APP1 EXIF segment', async () => {
        const bytes = new Uint8Array([
            0xff, 0xd8, 0xff, 0xe1, 0x00, 0x08, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x21, 0xff, 0xe1,
            0x00, 0x22, 0x45, 0x78, 0x69, 0x66, 0x00, 0x00, 0x4d, 0x4d, 0x00, 0x2a, 0x00, 0x00,
            0x00, 0x08, 0x00, 0x01, 0x01, 0x12, 0x00, 0x03, 0x00, 0x00, 0x00, 0x01, 0x00, 0x06,
