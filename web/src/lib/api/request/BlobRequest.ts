...
export default class BlobRequest implements Request<Blob> {
    ...
    public async send(): Promise<Blob> {
    ...
    private async doSend(resource: RequestInfo, init: RequestInit): Promise<Response> {
